...
import Obv.ConcreteSubjectB;
import Obv.SubjectS;

public class ClientClass {
    public static void main(String[] args) {
        AStockPrice futures1=new StockFutures("1");
        AStockPrice futures2=new StockFutures("2");
        AStockPrice futures3=new StockFutures("3");
        ...
        Buy3.AddHolder(futures3);Buy1.AddHolder(futures3);
        Buy3.AddHolder(common7);

        sell1.AddHolder(futures1);sell1.AddHolder(futures1);
        sell1.AddHolder(common5);

        sell2.AddHolder(futures1);sell1.AddHolder(futures1);
        sell2.AddHolder(common7);

        sell3.AddHolder(futures1);sell1.AddHolder(futures1);
